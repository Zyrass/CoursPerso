...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="../public/css/bower.css">
        <!-- FONT GOOLE -->
    ...
    <body>
        ...
        <main id="bower">
            <span><img src="https://bower.io/img/bower-logo.svg" alt="" class="bower"></span>
            <div class="container-fluid">
                <div class="row">
                    <div class="bg-warning text-center">
                        <h1><span><img src="https://scr.sad.supinfo.com/articles/resources/149178/2850/0.png" alt="" class="bower2"></span></h1>
                        <blockquote>
