...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="../public/css/git.css">
        <!-- FONT GOOLE -->
    ...
    <body>
        ...
        <main id="git">
            <span><img src="https://assets-cdn.github.com/images/modules/logos_page/Octocat.png" alt="" class="git"></span>
            <div class="container-fluid">
                <div class="row">
                    <div class="bg-warning text-center">
                        <h1><span><img src="https://www.developpez.com/public/images/news/git.png" alt="" class="git2"></span></h1>
                        <blockquote>
