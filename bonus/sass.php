...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <main id="sass">
            <span><img src="https://la-cascade.io/content/images/2015/05/sass-logo.svg" alt="" class="sass"></span>
            <div class="container-fluid">
                <div class="row">
                    <div class="bg-warning text-center">
                        <h1><span><img src="http://sass-lang.com/assets/img/illustrations/glasses-2087d741.svg" alt="" class="sass2"></span></h1>
                        <blockquote>
